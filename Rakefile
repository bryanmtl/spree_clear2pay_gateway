...
desc 'Generate documentation for the clear2pay_gateway extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'Clear2payGatewayExtension'
...
desc 'Test the clear2pay_gateway extension.'
...
namespace :test do
  desc 'Functional test the clear2pay_gateway extension.'
  ...
  desc 'Unit test the clear2pay_gateway extension.'
